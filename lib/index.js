...
class Service {
  ...
  create (body, params = {}) {
    ...
    debug(`Check if ${id} exists, and create blob ${id} with ext ${ext} and content type ${contentType}`)
      ...
      return new Promise((resolve, reject) => {
        this.Model.exists({
          ...
          if (props) {
            ...
            resolve(this._create(id, uri, buffer, params))
          }
        })
      })
    } else {
      return this._create(id, uri, buffer, params)
    }
  }
